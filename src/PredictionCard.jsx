...
const PredictionCard = () => {
  return (
    <div className="bg-[#162326] min-h-screen flex flex-col items-center justify-start pt-10 px-4">
      {/* Top Paragraph */}
      <p
        className="text-[#00e6e6] font-medium text-[18px] leading-[26px] md:text-[23px] md:leading-[30px] lg:text-[27px] lg:leading-[34px] tracking-widest text-left max-w-[355px]"
      ...
      {/* Leverage Paragraph */}
      <p
        className="text-[#ffffff] text-[14px] md:text-[15px] lg:text-[16px] leading-[24px] md:leading-[28px] lg:leading-[30px] tracking-widest mb-4 max-w-[400px] text-center"
        style={{ fontFamily: '"Noto Sans JP"', fontStyle: "normal" }}
      >
